...
export const FORMATIONS = {
  "4-3-3": {
    ...
    slots: [
      ...
      { id: "433-lb", position: "LB", x: 14, y: 68 },
      { id: "433-lcb", position: "CB", x: 37, y: 72 },
      { id: "433-rcb", position: "CB", x: 63, y: 72 },
      { id: "433-rb", position: "RB", x: 86, y: 68 },
      { id: "433-lcm", position: "CM", x: 28, y: 47 },
      { id: "433-rcm", position: "CDM", x: 68, y: 49 },
      { id: "433-cam", position: "CAM", x: 50, y: 38 },
      { id: "433-lw", position: "LW", x: 16, y: 17 },
      { id: "433-st", position: "ST", x: 50, y: 13 },
      { id: "433-rw", position: "RW", x: 84, y: 17 },
    ],
  },
  "4-4-2": {
    id: "4-4-2",
    ...
    slots: [
      ...
      { id: "442-lb", position: "LB", x: 14, y: 68 },
      { id: "442-lcb", position: "CB", x: 37, y: 72 },
      { id: "442-rcb", position: "CB", x: 63, y: 72 },
      { id: "442-rb", position: "RB", x: 86, y: 68 },
      { id: "442-lm", position: "LM", x: 16, y: 44 },
      { id: "442-lcm", position: "CM", x: 39, y: 49 },
      { id: "442-rcm", position: "CDM", x: 61, y: 49 },
      { id: "442-rm", position: "RM", x: 84, y: 44 },
      { id: "442-lst", position: "ST", x: 36, y: 14 },
      { id: "442-rst", position: "ST", x: 64, y: 14 },
    ],
  },
  "3-5-2": {
    id: "3-5-2",
    ...
    defenceRisk: 1.06,
    slots: [
      { id: "352-gk", position: "GK", x: 50, y: 90 },
      { id: "352-lcb", position: "CB", x: 22, y: 69 },
      { id: "352-cb", position: "CB", x: 50, y: 68 },
      { id: "352-rcb", position: "CB", x: 78, y: 69 },
      { id: "352-lwb", position: "LWB", x: 12, y: 47 },
      { id: "352-lcm", position: "CM", x: 35, y: 47 },
      { id: "352-cam", position: "CAM", x: 50, y: 36 },
      { id: "352-rcm", position: "CDM", x: 65, y: 51 },
      { id: "352-rwb", position: "RWB", x: 88, y: 47 },
      { id: "352-lst", position: "ST", x: 36, y: 13 },
      { id: "352-rst", position: "ST", x: 64, y: 13 },
    ],
  },
  "4-5-1": {
    id: "4-5-1",
    ...
    slots: [
      ...
      { id: "451-lb", position: "LB", x: 10, y: 68 },
      { id: "451-lcb", position: "CB", x: 32, y: 71 },
      { id: "451-rcb", position: "CB", x: 68, y: 71 },
      { id: "451-rb", position: "RB", x: 90, y: 68 },
      { id: "451-lw", position: "LW", x: 9, y: 39 },
      { id: "451-lcm", position: "CM", x: 28, y: 47 },
      { id: "451-cdm", position: "CDM", x: 50, y: 52 },
      { id: "451-rcm", position: "CM", x: 72, y: 47 },
      { id: "451-rm", position: "RM", x: 91, y: 39 },
      { id: "451-st", position: "ST", x: 50, y: 13 },
    ],
  },
  "4-2-3-1": {
    id: "4-2-3-1",
    ...
    slots: [
      ...
      { id: "4231-lb", position: "LB", x: 14, y: 68 },
      { id: "4231-lcb", position: "CB", x: 37, y: 72 },
      { id: "4231-rcb", position: "CB", x: 63, y: 72 },
      { id: "4231-rb", position: "RB", x: 86, y: 68 },
      { id: "4231-lcdm", position: "CDM", x: 36, y: 50 },
      { id: "4231-rcdm", position: "CDM", x: 64, y: 50 },
      { id: "4231-lw", position: "LW", x: 16, y: 32 },
      { id: "4231-cam", position: "CAM", x: 50, y: 37 },
      { id: "4231-rw", position: "RW", x: 84, y: 32 },
  ...
  "3-4-2-1": {
    ...
    defenceRisk: 1.08,
    slots: [
      { id: "3421-gk", position: "GK", x: 50, y: 90 },
      { id: "3421-lcb", position: "CB", x: 22, y: 69 },
      { id: "3421-cb", position: "CB", x: 50, y: 68 },
      { id: "3421-rcb", position: "CB", x: 78, y: 69 },
      { id: "3421-lm", position: "LM", x: 12, y: 46 },
      { id: "3421-lcm", position: "CM", x: 35, y: 48 },
      { id: "3421-rcm", position: "CM", x: 65, y: 48 },
      { id: "3421-rm", position: "RM", x: 88, y: 46 },
      { id: "3421-lw", position: "LW", x: 25, y: 25 },
      { id: "3421-rw", position: "RW", x: 75, y: 25 },
  ...
  "5-4-1": {
    ...
    defenceRisk: 0.9,
    slots: [
      { id: "541-gk", position: "GK", x: 50, y: 90 },
      { id: "541-lwb", position: "LWB", x: 9, y: 65 },
      { id: "541-lcb", position: "CB", x: 28, y: 70 },
      { id: "541-cb", position: "CB", x: 50, y: 68 },
      { id: "541-rcb", position: "CB", x: 72, y: 70 },
      { id: "541-rwb", position: "RWB", x: 91, y: 65 },
      { id: "541-lm", position: "LM", x: 18, y: 41 },
      { id: "541-lcm", position: "CM", x: 40, y: 46 },
      { id: "541-rcm", position: "CM", x: 60, y: 46 },
      { id: "541-rw", position: "RW", x: 82, y: 41 },
      { id: "541-st", position: "ST", x: 50, y: 12 },
    ],
  }
};
