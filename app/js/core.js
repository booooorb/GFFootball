...
export const FORMATIONS = {
  "4-3-3": {
    ...
    slots: [
      ...
      { id: "433-lb", position: "LB", x: 14, y: 65 },
      { id: "433-lcb", position: "CB", x: 37, y: 69 },
      { id: "433-rcb", position: "CB", x: 63, y: 69 },
      { id: "433-rb", position: "RB", x: 86, y: 65 },
      { id: "433-lcm", position: "CM", x: 28, y: 44 },
      { id: "433-rcm", position: "CDM", x: 68, y: 46 },
      { id: "433-cam", position: "CAM", x: 50, y: 35 },
  ...
  "4-4-2": {
    ...
    slots: [
      ...
      { id: "442-lb", position: "LB", x: 14, y: 65 },
      { id: "442-lcb", position: "CB", x: 37, y: 69 },
      { id: "442-rcb", position: "CB", x: 63, y: 69 },
      { id: "442-rb", position: "RB", x: 86, y: 65 },
      { id: "442-lm", position: "LM", x: 16, y: 41 },
      { id: "442-lcm", position: "CM", x: 39, y: 46 },
      { id: "442-rcm", position: "CDM", x: 61, y: 46 },
      { id: "442-rm", position: "RM", x: 84, y: 41 },
  ...
  "3-5-2": {
    ...
    slots: [
      ...
      { id: "352-lcb", position: "CB", x: 22, y: 66 },
      { id: "352-cb", position: "CB", x: 50, y: 65 },
      { id: "352-rcb", position: "CB", x: 78, y: 66 },
      { id: "352-lwb", position: "LWB", x: 12, y: 44 },
      { id: "352-lcm", position: "CM", x: 35, y: 44 },
      { id: "352-cam", position: "CAM", x: 50, y: 33 },
      { id: "352-rcm", position: "CDM", x: 65, y: 48 },
      { id: "352-rwb", position: "RWB", x: 88, y: 44 },
  ...
  "4-5-1": {
    ...
    slots: [
      ...
      { id: "451-lb", position: "LB", x: 10, y: 65 },
      { id: "451-lcb", position: "CB", x: 32, y: 68 },
      { id: "451-rcb", position: "CB", x: 68, y: 68 },
      { id: "451-rb", position: "RB", x: 90, y: 65 },
      { id: "451-lw", position: "LW", x: 9, y: 36 },
      { id: "451-lcm", position: "CM", x: 28, y: 44 },
      { id: "451-cdm", position: "CDM", x: 50, y: 49 },
      { id: "451-rcm", position: "CM", x: 72, y: 44 },
      { id: "451-rm", position: "RM", x: 91, y: 36 },
  ...
  "4-2-3-1": {
    ...
    slots: [
      ...
      { id: "4231-lb", position: "LB", x: 14, y: 65 },
      { id: "4231-lcb", position: "CB", x: 37, y: 69 },
      { id: "4231-rcb", position: "CB", x: 63, y: 69 },
      { id: "4231-rb", position: "RB", x: 86, y: 65 },
      { id: "4231-lcdm", position: "CDM", x: 36, y: 47 },
      { id: "4231-rcdm", position: "CDM", x: 64, y: 47 },
      { id: "4231-lw", position: "LW", x: 16, y: 29 },
      { id: "4231-cam", position: "CAM", x: 50, y: 34 },
      { id: "4231-rw", position: "RW", x: 84, y: 29 },
  ...
  "3-4-2-1": {
    ...
    slots: [
      ...
      { id: "3421-lcb", position: "CB", x: 22, y: 66 },
      { id: "3421-cb", position: "CB", x: 50, y: 65 },
      { id: "3421-rcb", position: "CB", x: 78, y: 66 },
      { id: "3421-lm", position: "LM", x: 12, y: 43 },
      { id: "3421-lcm", position: "CM", x: 35, y: 45 },
      { id: "3421-rcm", position: "CM", x: 65, y: 45 },
      { id: "3421-rm", position: "RM", x: 88, y: 43 },
  ...
  "5-4-1": {
    ...
    slots: [
      ...
      { id: "541-lwb", position: "LWB", x: 9, y: 62 },
      { id: "541-lcb", position: "CB", x: 28, y: 67 },
      { id: "541-cb", position: "CB", x: 50, y: 65 },
      { id: "541-rcb", position: "CB", x: 72, y: 67 },
      { id: "541-rwb", position: "RWB", x: 91, y: 62 },
      { id: "541-lm", position: "LM", x: 18, y: 38 },
      { id: "541-lcm", position: "CM", x: 40, y: 43 },
      { id: "541-rcm", position: "CM", x: 60, y: 43 },
      { id: "541-rw", position: "RW", x: 82, y: 38 },
